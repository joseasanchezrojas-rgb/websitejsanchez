...
const Hero = ({ idioma }) => {
  ...
  <a 
    ...
    target="_blank" 
    rel="noreferrer" 
    aria-label="Sigue mi perfil profesional en Instagram" 
  ...
  <a 
    ...
    target="_blank" 
    rel="noreferrer" 
    aria-label="Explora mis repositorios de código en GitHub" 
    className="hover:text-white hover:scale-110 transition-all"
  >
    <Github size={24}/>
  </a>
  ...
  <a 
    ...
    target="_blank" 
    rel="noreferrer" 
    aria-label="Conecta conmigo profesionalmente en LinkedIn" 
  ...
  <a 
    ...
    target="_blank" 
    rel="noreferrer" 
    aria-label="Envíame un mensaje directo por WhatsApp" 
