    ...
    <div className="min-h-screen bg-black bg-dots text-gray-100 font-sans selection:bg-blue-500/30">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-black/60 backdrop-blur-md border-b border-white/5">
        <div className="max-w-5xl mx-auto px-6 h-16 flex items-center justify-between">
          {/* Logo / Nombre en la esquina izquierda */}
      ...
      {/* Ajuste de margen para que el contenido no quede debajo de la barra fija */}
      ...
      <main className="max-w-5xl mx-auto px-6 pb-24">
        ...
        <section className="max-w-2xl mx-auto mb-20">
          ...
          <LinkCard 
            title="Mi Curso de React" 
            description="Aprende desde las bases hasta nivel experto." 
            url="#" 
            icon={Code2} 
          />
          <LinkCard 
            title="Setup de Desarrollo" 
            description="Las herramientas que uso en mi día a día." 
            url="#" 
            icon={Layers} 
          />
        </section>
